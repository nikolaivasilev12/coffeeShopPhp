        ...
        <div class="carousel-inner">
            ...
            ?>
                <div class="carousel-item active">
                    <img class="d-block w-100" <?php
                    if (isset($value['image'])) { ?> src="data:image/jpg;base64,<?php echo base64_encode(file_get_contents("uploads/{$value['image']}")); ?>" <?php
                        } else {
                            ?> src="https://unblast.com/wp-content/uploads/2019/05/Paper-Pouch-Packaging-Mockup-2.jpg" <?php
                        }
                    ?> alt="">
...
<div class="d-flex flex-column align-items-center">
    ...
    <form class="col-3 mt-2" action="" method="post">
        <div class="form-group">
            ...
            <input maxlength="50" type="user_name" name="user_name" class="form-control" placeholder="Enter Your Name" required>
        </div>
        <div class="form-group">
            <label class="font-weight-bold">Email</label>
            <input maxlength="50" type="user_email" name="user_email" class="form-control" placeholder="Enter Your Email" required>
        </div>
        <div class="form-group">
            <label class="font-weight-bold">Subject</label>
            <input maxlength="50" type="subject" name="subject" class="form-control" placeholder="Enter Your Subject" required>
        </div>
        <div class="form-group">
            <label class="font-weight-bold">Message</label>
            <textarea maxlength="250" rows="3" type="content" name="content" class="form-control" required></textarea>
        </div>
...
<script>
    grecaptcha.ready(function() {
        grecaptcha.execute("<?php echo $captchaSec; ?>", {
            action: 'contact'
        }).then(function(token) {
